...
def rename2(collection):
    os.getcwd()
    for i,filename in enumerate(os.listdir(collection)):
        os.rename("data/test/" + filename, "data/train/" + str(i)+"t"+ ".jpg")

def rename1(collection):
    os.getcwd()
    for i,filename in enumerate(os.listdir(collection)):
        os.rename("data/train/" + filename, "data/train/" + str(i)+ ".jpg")
		
def renameNew(collection):
    os.getcwd()
    for i,filename in enumerate(os.listdir(collection)):
        os.rename("data/train/" + filename, "data/train/" + str(i)+ "train"+".jpg")
